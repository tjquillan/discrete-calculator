...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "implies", "symbols": ["implies", {"literal":"→"}, "xor"], "postprocess": (d) => new Implies(d[1], d[0], d[2])},
    ...
    {"name": "paren", "symbols": [{"literal":"("}, "proposition", {"literal":")"}], "postprocess": (d) => new Paren(null, d[1], null)},
